...
**Backend**
: Node.js, NestJS, TypeORM, TypeScript, Kotlin, Spring Boot

**Database**
: PostgreSQL, TimescaleDB, Redis, MySQL, MongoDB

**Realtime & Messaging**
: Kafka, Redis Pub/Sub·Stream, WebSocket, SSE, STOMP

**Frontend**
: Next.js, React, Vite

**Cloud & Infra**
: AWS EKS, AWS ECS, AWS RDS·ElastiCache, Terraform, Docker, GitHub Actions, Prometheus, Grafana, k6
